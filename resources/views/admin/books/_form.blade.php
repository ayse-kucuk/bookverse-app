...
<div>
    <label class="mb-1 block text-xs font-bold text-slate-600">{{ __('ui.admin.form_title') }}</label>
...
<div>
    <label class="mb-1 block text-xs font-bold text-slate-600">{{ __('ui.admin.form_author') }}</label>
...
<div>
    <label class="mb-1 block text-xs font-bold text-slate-600">{{ __('ui.admin.form_category') }}</label>
    <select name="category_id" required class="bv-input w-full rounded-xl border border-slate-200 px-3 py-2.5 text-sm">
        <option value="">{{ __('ui.admin.form_category_select') }}</option>
...
<div class="grid gap-4 sm:grid-cols-2">
    <div>
        <label class="mb-1 block text-xs font-bold text-slate-600">{{ __('ui.admin.form_pages') }}</label>
    ...
    <div class="flex items-end pb-1">
        <label class="flex items-center gap-2 text-xs font-bold text-slate-600">
            ...
            {{ __('ui.admin.form_protect') }}
        </label>
    </div>
</div>

<div>
    <label class="mb-1 block text-xs font-bold text-slate-600">{{ __('ui.admin.form_cover_url') }}</label>
...
<div>
    <label class="mb-1 block text-xs font-bold text-slate-600">{{ __('ui.admin.form_description') }}</label>
